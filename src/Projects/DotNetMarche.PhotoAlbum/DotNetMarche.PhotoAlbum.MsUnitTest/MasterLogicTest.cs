...
namespace DotNetMarche.PhotoAlbum.MsUnitTest
{
    ...
    public class MasterLogicTest
    {
        ...
        {
            PrivateObject param0 = new PrivateObject(new MasterLogic(new MyTestUrlHelper())); // TODO: Initialize to an appropriate value
            MasterLogic_Accessor target = new MasterLogic_Accessor(param0); // TODO: Initialize to an appropriate value
            string menuFileName = @"BaseMenu1.xml";
            MenuItem expected = new MenuItem("TEST");
            MenuItem actual;
            actual = target.CreateMenu(menuFileName);
