...
$.prototype = {
   ...
   transictionto: function(settings) {
      /// <summary>
      /// Applied to a wrapped-set containing images it transiction all images to a
      /// destination image
      /// </summary>
      /// <returns type="jQuery"></returns>
      /// <param name="settins">An object containing the settings: destinationImage is the name
      /// of destination image</param>
   },
   log: function(name) {
      /// <summary>
      /// Log to firebug console actual wrapped set.
      /// </summary>
      /// <returns type="jQuery"></returns>
      /// <param name="message">A message to distinguish selected items</param>
   },
