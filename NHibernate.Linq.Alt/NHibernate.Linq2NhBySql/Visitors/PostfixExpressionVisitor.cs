...
{
    /// <summary>
    /// To posfix visit it is enough to ovveride visit, and simply 
    /// first call base visit and then visiting the node, the problem
    /// is with specific methods, because the base expression visitor
    /// invoke in preorder. This Class is used to simply traslate
    /// the invocation in postorder.
    /// </summary>
