...
<div id="insertNewPhotoAlbum" class="formbase">
 <p>Insert data for new album
 </p>
    <p>
    ...
    <p>
        <asp:Button ID="btnAddNewElement" CssClass="submitter" runat="server" Text="AddNew" OnClick="btnAddNewElement_Click" />
    </p>
</div>
