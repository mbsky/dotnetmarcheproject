...
{
	/// <summary>
	/// original nunit class reported here for modification.
	/// </summary>
	public class ConstraintBuilder
	{
		...
		System.Collections.Stack ops = new System.Collections.Stack();

		System.Collections.Stack opnds = new Stack();
		...
		/// EqualConstraint as base.
		/// </summary>
		public Constraint ObjectEqual(object expected)
		{
			return Resolve(new ObjectEqualConstraint(expected));
		}
		...
		/// </summary>
		public Constraint EquivalentTo(System.Collections.ICollection expected)
		{
